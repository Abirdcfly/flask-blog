...
class Config:
    ...
    AWOTER_FOLLOWERS_PER_PAGE = 30
    AWOTER_COMMENTS_PER_PAGE = 30
...
class ProductionConfig(Config):
    ...
    def init_app(cls, app):
        ...
        mail_handler = SMTPHandler(
            ...
            fromaddr=cls.AWOTER_MAIL_SENDER,
            toaddrs=[cls.AWOTER_ADMIN],
            subject=cls.AWOTER_MAIL_SUBJECT_PREFIX + ' Application Error',
